...
echo "docker run -d --name sbdd-paris-telegram-uploader -e BOT_TOKEN=<your-bot-token> -v /path/to/kirby/content:/usr/src/app/kirby/content milangress/sbdd-paris-telegram-uploader:latest" 